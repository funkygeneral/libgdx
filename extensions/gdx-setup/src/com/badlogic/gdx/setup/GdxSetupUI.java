...
public class GdxSetupUI extends JFrame {
    ...
    class UI extends JPanel {
        ...
        private void uiLayout() {
            ...
            add(buttonPanel, new GridBagConstraints(0, 2, 1, 1, 0, 0, CENTER, NONE, new Insets(10, 0, 0, 0), 10, 10));
    ...
    class Form extends JPanel {
        ...
        private void uiLayout() {
            ...
            add(showMoreExtensionsButton, new GridBagConstraints(0, 15, 0, 1, 0, 0, CENTER, WEST, new Insets(20, 0, 10, 0), 10, 10));
        }
